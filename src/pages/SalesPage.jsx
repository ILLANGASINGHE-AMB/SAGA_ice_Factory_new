...
The Total is : LKR ${amount.toLocaleString()}`;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm p-4 flex flex-wrap items-center gap-4 justify-between">
      ...
      <Table
        ...
        renderRow={(sale) => (
          <tr key={sale.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 border-b border-slate-100 dark:border-slate-800">
            <td className="px-6 py-4 font-mono font-medium text-navy-600 dark:text-navy-400">{sale.sale_code}</td>
            <td className="px-6 py-4 font-semibold text-slate-900 dark:text-slate-100">{sale.customer?.name}</td>
            <td className="px-6 py-4"><Badge type={sale.cube_type === 'manufactured' ? 'MFC' : 'RSC'} /></td>
            <td className="px-6 py-4 font-mono">{sale.quantity.toLocaleString()}</td>
            <td className="px-6 py-4 font-semibold font-mono text-slate-800 dark:text-slate-200">LKR {sale.total_amount.toLocaleString()}</td>
            <td className="px-6 py-4"><Badge type={sale.payment_type} /></td>
            <td className="px-6 py-4 text-xs text-slate-400">{new Date(sale.sale_date).toLocaleString()}</td>
      ...
      >
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className={`p-6 rounded-2xl border text-center transition flex flex-col items-center justify-center space-y-2 ${
                  paymentType === 'cash'
              ...
              >
                ...
                <span className="font-semibold text-sm">Cash Sales</span>
              ...
              >
                ...
                <span className="font-semibold text-sm">Debt Credit</span>
        ...
        {step === 2 && (
          <div className="space-y-4 py-2">
            {!showMiniCustomerForm ? (
              <>
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Search existing registry or create a new client:
                </p>
                <div className="relative">
                  ...
                  {customerSearchQuery.trim() !== '' && !customerId && (
                    <div className="absolute top-full left-0 right-0 mt-1 max-h-40 overflow-y-auto bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50 divide-y divide-slate-100 dark:divide-slate-800">
                      {filteredCustomersForSearch.length === 0 ? (
                        ...
                        filteredCustomersForSearch.map(c => (
                          <div
                            key={c.id}
                            className="p-3 text-xs cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 flex justify-between items-center text-slate-800 dark:text-slate-200"
                ...
                <div className="text-center pt-2">
                  ...
                  <button
                    ...
                    className="text-xs text-navy-600 dark:text-navy-400 font-bold hover:underline"
                  >
                    Register Mini-Form
                  </button>
                </div>
              ...
              <div className="space-y-3 bg-slate-50 dark:bg-slate-800/20 p-4 rounded-xl border border-slate-150 dark:border-slate-800">
        ...
        {step === 3 && (
          <div className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-4 items-end">
              ...
              />
              <div className="bg-slate-50 dark:bg-slate-800/50 p-2.5 rounded-lg border border-slate-200 dark:border-slate-800 flex justify-between items-center text-xs h-[38px]">
            ...
            {/* Total Preview */}
            <div className="p-4 bg-navy-50/50 dark:bg-navy-950/20 border border-navy-100 dark:border-navy-900/50 rounded-xl flex justify-between items-center">
              <span className="text-sm font-semibold text-slate-600 dark:text-slate-300">Auto-Calculated Total:</span>
              <span className="text-lg font-extrabold font-heading text-navy-600 dark:text-navy-400">
        ...
        {step === 4 && (
          <div className="space-y-4 py-2">
            ...
            <div className="border border-slate-200 dark:border-slate-800 rounded-xl divide-y divide-slate-150 dark:divide-slate-800 bg-slate-50/50 dark:bg-slate-900/30 p-4 space-y-3">
              ...
              <div className="flex justify-between text-sm py-2 font-bold text-navy-600 dark:text-navy-400">
