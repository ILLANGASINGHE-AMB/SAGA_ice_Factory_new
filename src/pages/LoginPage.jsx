...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#80c5ff] bg-gradient-to-br from-[#cbe5ff] via-[#66b3ff] to-[#3399ff] flex items-center justify-center p-6 relative overflow-hidden font-sans select-none">
      ...
      <div className="w-full max-w-[420px] bg-white rounded-[36px] shadow-2xl p-10 flex flex-col items-center space-y-8 relative z-10 border border-white/20">
        ...
        <div className="flex flex-col items-center text-center space-y-2.5">
          {settings?.logo_url ? (
            ...
            <div className="text-[#005cbf] flex items-center justify-center">
              <Snowflake size={64} className="stroke-[1.5] animate-pulse" />
            </div>
          )}

          <div className="flex flex-col items-center">
            <h1 className="text-3xl font-extrabold font-heading tracking-wider text-[#003366] uppercase leading-none">
              {firstWord}
            </h1>
            <div className="flex items-center justify-center w-full my-2 space-x-2">
              <div className="h-[1.5px] w-8 bg-[#005cbf]" />
        ...
        <form className="w-full space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 text-sm bg-[#f0f4f8] hover:bg-[#e4ebf3] focus:bg-white border border-transparent focus:border-blue-500/25 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none transition shadow-inner"
              />
            </div>
          </div>
          ...
          <Button
            type="submit"
            className="w-full py-3 rounded-xl font-bold bg-[#005cbf] hover:bg-[#004a9b] text-white flex items-center justify-center space-x-2 pt-3 shadow-md shadow-blue-500/10 hover:scale-[1.01] transition-all duration-200"
            isLoading={isLoading}
          >
            <LogIn size={16} />
            <span>Sign In</span>
        ...
        {/* Credentials hints exactly matching mockups */}
